    ...
    <div className="container mx-auto max-sm:mt-0 mt-4">
      <div className=" w-full flex  justify-between max-xl:px-4 ">
        ...
        <Button
          ...
          className={
            "bg-gradient-to-r from-emerald-700 to-green-600 hover:from-green-600 hover:to-emerald-700  rounded-lg shadow-lg  flex items-center justify-center max-sm:fixed max-sm:bottom-0 max-sm:right-0 max-sm:rounded-none z-40 max-sm:w-full transition duration-300  ease-in-out py-2 disabled:from-emerald-600 disabled:to-green-400 disabled:text-gray-50 "
          }
          disabled={
